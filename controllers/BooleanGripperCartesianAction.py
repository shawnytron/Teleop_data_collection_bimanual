...
class VRPolicy:
    def __init__(
        ...
        rmat_reorder: list = [1, -2, -3, 4], #have to do with conversion reording and daaformat from oculus vs global
    ):
    ...
    def _calculate_action(self, state_dict, include_info=False):
        ...
        # Read Observation
        # robot_state: [j1, j2, j3, j4, j5, j6, x, y, z, qx, qy, qz, qw, ...]
        robot_pos = np.array(state_dict["robot_state"][6:9]) #read position
        robot_quat = state_dict["robot_state"][9:13] 
