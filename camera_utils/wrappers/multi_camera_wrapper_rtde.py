...
class MultiCameraWrapper:
    def __init__(self):
        ...
        print(f"Device: Intel Realsense D405 - User Camera")
    ...
    def read_cameras(self):
        ...
        user_color_frame = user_frames.get_color_frame()
                                       
        user_frame = np.asanyarray(user_color_frame.get_data())

        # reshape image frames to (480, 640, 3)
        user_frame = user_frame[20:430, 50:500]
        user_frame = cv2.resize(np.array(user_frame),(640,640))
        ...
        return secondpov_frame, user_frame
