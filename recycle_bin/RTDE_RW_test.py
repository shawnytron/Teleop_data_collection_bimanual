...
class RobotAction:
    def __init__(self, robot_ip="192.168.0.110", acceleration=0.5, velocity=0.5, do_reset=True, camera_kwargs = {}):
        """
        ...
        self.primary_cameraPath, self.wrist_cameraPath = self.camera_reader.read_cameras()
    ...
    def send_action(self,action,non_blocking=True,velocity=0.50,accel=0.40):
